...
type TbPlan struct {
	...
	CreatorName      string     `gorm:"column:creator_name;type:varchar(45);default:null;comment:'创建人编码'"`                                                                    // 创建人编码
	...
	DeleteAt         *time.Time `gorm:"index:deleted_at_index;column:delete_at;type:datetime;default:null;comment:'删除时间'"`                                                    // 删除时间
}

// TableName get sql table name.获取数据库表名
func (m *TbPlan) TableName() string {
	return "tb_plan"
}
